// StorePackage/editChef/cuisineImg/cuisineImg.js
const app = getApp()
	...
	UploadImages() {
		for (let i = 0; i < this.data.imgList.length; i++) {
			...
			if (fileName.includes('http://') || fileName.includes('wxfile://')) {
				...
				const cloudPath = "chefCuisineImg/" + Date.now() + Math.floor(Math.random(0, 1) * 10000000) + '.jpg'; // HouseImg/后面的内容为图片名称
				wx.cloud.uploadFile({
						cloudPath,
