// Adminpackage/storeManageDetail/storeManageDetail.js
const app = getApp()
...
Page({
     ...
     */
    addGoods() {
        let url = '/StorePackage/addGoods/addGoods'
        let id = this.data.storeId
        wx.navigateTo({
            url: `${url}?id=${id}`,
        })
     ...
     */
    addChef() {
        let url = '/StorePackage/addChef/addChef'
        let id = this.data.storeId
        wx.navigateTo({
            url: `${url}?id=${id}`,
        })
        ...
        wx.showActionSheet({
            ...
            success: res => {
                if (res.tapIndex === 0) {
                    //修改模式
                    wx.navigateTo({
                        url: '/StorePackage/editGoods/editGoods?id=' + id,
                    })
                }
                if (res.tapIndex === 1) {
                    //删除模式
    ...
    longPressChef(e) {
        ...
        wx.showActionSheet({
            ...
            success: res => {
                if (res.tapIndex === 0) {
                    wx.navigateTo({
                        url: '/StorePackage/editChef/editChef?id=' + id,
                    })
                }
                if (res.tapIndex === 1) {
                    //删除模式
